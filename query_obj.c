...
void help(void)
{
	fprintf(stdout, "Usage: mlx5ctl <device> obj <obj_name> --id=<obj_id> [--bin]\n");
...
QUERY_FUNC(issi)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_issi_in);
	...
	MLX5_SET(query_issi_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(vnic_env)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_vnic_env_in);
	...
	MLX5_SET(query_vnic_env_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(special_contexts)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_special_contexts_in);
	...
	MLX5_SET(query_special_contexts_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(mad_demux)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_mad_demux_in);
	...
	MLX5_SET(query_mad_demux_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(cong_statistics)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_cong_statistics_in);
	...
	MLX5_SET(query_cong_statistics_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(adapter)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_adapter_in);
	...
	MLX5_SET(query_adapter_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(wol_rol)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_wol_rol_in);
	...
	MLX5_SET(query_wol_rol_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(lag)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_lag_in);
	...
	MLX5_SET(query_lag_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(esw_functions)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_esw_functions_in);
	...
	MLX5_SET(query_esw_functions_in, in, op_mod, obj_id);
}
...
QUERY_FUNC(sf_partitions)
{
	...
	*in_sz = MLX5_ST_SZ_BYTES(query_sf_partitions_in);
	...
	MLX5_SET(query_sf_partitions_in, in, op_mod, obj_id);
}
#endif
...
struct obj_name_func query_funcs[] = {
	...
	QUERY_PAIR(vnic_env, "--id=op_mod"),
	QUERY_PAIR(packet_reformat_context, "--id=packet_reformat_id"),
	QUERY_PAIR(special_contexts, "--id=op_mod"),
	QUERY_PAIR(mad_demux, "--id=op_mod"),
	QUERY_PAIR(cong_statistics, "--id=op_mod"),
	QUERY_PAIR(cong_params, "--id=cong_protocol"),
	QUERY_PAIR(cong_status, "--id=priority:cong_protocol"),
	QUERY_PAIR(adapter, "--id=op_mod"),
	QUERY_PAIR(wol_rol, "--id=op_mod"),
	QUERY_PAIR(lag, "--id=op_mod"),
	QUERY_PAIR(esw_functions, "--id=op_mod"),
